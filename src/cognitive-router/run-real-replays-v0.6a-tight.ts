...
import { runRealReplaysV06aTightSuite } from "./replay-evaluator.js";

const report = runRealReplaysV06aTightSuite();
const reportPath = writeSuiteReport(report, "reports/real-replays-v0.6a-tight");
