...
const coreV05Report = runDebuggingCoreV05Suite();
...
const coreV05Path = writeSuiteReport(coreV05Report, "reports/debugging-v0.5");
...
console.log(
  JSON.stringify(
    {
      overall_pass: coreV05Report.overall_pass,
      tests: coreV05Report.tests,
    },
    null,
    2,
  ),
