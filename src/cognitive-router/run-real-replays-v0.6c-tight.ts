...
import { runRealReplaysV06cTightSuite } from "./replay-evaluator.js";

const report = runRealReplaysV06cTightSuite();
const reportPath = writeSuiteReport(report, "reports/real-replays-v0.6c-tight");
