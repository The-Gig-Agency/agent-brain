...
import { runRealReplaysV06bDiverseSuite } from "./replay-evaluator.js";

const report = runRealReplaysV06bDiverseSuite();
const reportPath = writeSuiteReport(report, "reports/real-replays-v0.6b-diverse");
